...
def main():
    ...
    volBar = 400
    volPer = 0
    length_value_multiplier = float(input(
        'Select the length value, use a value of 3 for a more sensitive volume control, and a value of 4 for a less sensitive control, or a fload number between them :  '))
